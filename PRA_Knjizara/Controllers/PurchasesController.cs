...
namespace PRA_Knjizara.Controllers
{
    ...
    public class PurchasesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ReceiptID,BookID,Quantity")] Purchase purchase)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Administrator")]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ReceiptID,BookID,Quantity")] Purchase purchase)
        {
            if (id != purchase.Id)
            {
                return NotFound();
